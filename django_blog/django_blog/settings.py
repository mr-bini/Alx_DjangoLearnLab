...
TEMPLATES = [
    {
        ...
        # You can add a global templates directory if needed
...
# To use PostgreSQL, uncomment and configure below:
# DATABASES = {
#     'default': {
...
# Optional: define STATICFILES_DIRS if you have global static files
...
# Login and logout redirects (optional)
